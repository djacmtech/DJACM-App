...
public class StudentViewPagerAdaptor extends FragmentStatePagerAdapter {
    FragmentManager fm;
    Context context;
    Fragment Department, EventFrag, IF, Home;
    FragmentListener listener = new FragmentListener();
    SharedPreferences switchTo;
    SharedPreferences.Editor editor;

    public final class FragmentListener implements NestedFragmentListener {
...
//                case "screen1":
//                    editor.clear().commit();
//                    fm.beginTransaction().remove(Home)
//                            .commit();
//                    Home = new ApplicationForm(listener);
//                    break;
//                case "screen2":
//                    editor.clear().commit();
//                    fm.beginTransaction().remove(Home)
//                            .commit();
//                    Home = new Screen2Fragment(listener);
//                    break;
                case "Home":
                    editor.clear().commit();
                    fm.beginTransaction().remove(Home)
